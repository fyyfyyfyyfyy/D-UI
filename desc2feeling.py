...
) -> typing.Tuple[Religion, typing.Any]:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        religion_1, religion_1_data = extract_religion(
            user_input,
            desire_name_list_1,
            chat_history
        )
